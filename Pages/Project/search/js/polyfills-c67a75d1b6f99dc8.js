...
function() {
  ...
  function(t) {
    return "Array" == h(t)
      ...
      return function(u, s, c, f) {
        for (var l, h, p = Ut(u), v = d(p), g = te(s, c, 3), y = ft(v.length), m = 0, b = f || ie, w = e ? b(u, y) : r ? b(u, 0) : void 0; y > m; m++) if ((a || m in v) && (h = g(l = v[m], m, p), t)) if (e) w[m] = h;
        else if (h) switch (t) {
        case 3:
          return !0;
        case 5:
  ...
  var Me = {
    ...
    BUGGY_SAFARI_ITERATORS: Ue
      ...
      We = Object.setPrototypeOf || ("__proto__" in {} ?
    function() {
      var t, e = !1,
          r = {};
      try {
      ...
      if (g && (u = ke(g.call(new t)), Ke !== Object.prototype && u.next && (ke(u) !== Ke && (We ? We(u, Ke) : "function" != typeof u[$e] && T(u, $e, Ye)), Ce(u, l, !0))), o == He && d && d.name !== He && (h = !0, v = function() {
        ...
        keys: i ? v : f(Ve),
        entries: f(Xe)
      }, a) for (c in s)(Ge || h || !(c in p)) && rt(p, c, s[c]);
      else Lt({
        target: e,
        proto: !0,
        forced: Ge || h
  ...
  var Ui = qt("species"),
      ...
      if (!a || !u || "replace" === t && (!Mi || !_i || Ci) || "split" === t && !Fi) {
        var s = /./ [i],
            ...
            f = c[1];
        rt(String.prototype, t, c[0]), rt(RegExp.prototype, i, 2 == e ?
        function(t, e) {
  ...
  Bi("split", 2, function(t, e, r) {
    var n;
    return n = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ?
    function(t, r) {
      var n = String(v(this)),
          o = void 0 === r ? Yi : r >>> 0;
      if (0 === o) return [];
  ...
  var bs, ws = {
    ...
    getState: rs
      ...
      if (void 0 !== o) if (o instanceof Pc) e = Rs(o);
  ...
  Jc && Qc || (Jc = function(t) {
    ...
    ef.now(af(t))
  } : tf && !Xc ? (Vc = ($c = new tf).port2, $c.port1.onmessage = uf, Gc = te(Vc.postMessage, Vc, 1)) : !n.addEventListener || "function" != typeof postMessage || n.importScripts || o(sf) || "file:" === Yc.protocol ? Gc = "onreadystatechange" in x("script") ?
  function(t) {
  ...
  }), "function" != typeof Hc || Hc.prototype.
  finally || rt(Hc.prototype, "finally", it("Promise").prototype.
  finally);
  var cl = et.set,
  ...
  var pl = "URLSearchParams" in self,
      ...
      vl = "FileReader" in self && "Blob" in self &&
      function() {
      try {
        return new Blob, !0
      } catch (t) {
